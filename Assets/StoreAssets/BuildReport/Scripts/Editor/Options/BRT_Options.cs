...
public static class Options
{
	...
	public const string BUILD_REPORT_TOOL_DEFAULT_PATH = "Assets/StoreAssets/BuildReport";
	...
	static string DefaultOptionsPath
	{
		get
		{
			return string.Format("{0}/StoreAssets/BuildReport/{1}", Application.dataPath, SAVED_OPTIONS_FILENAME);
		}
	}
	...
	static bool IsBuildReportInRegularPaths
	{
		get
		{
			return Directory.Exists(string.Format("{0}/StoreAssets/BuildReport", Application.dataPath)) ||
